...
import click.dobel.tado.exporter.apiclient.auth.AuthenticationState
...
@RestController
class BaseRedirect(
  private val tadoAuthenticationState: TadoAuthenticationState
) {
  companion object {
  ...
  fun getAuthenticationRow(): String {
    ...
    val result = if (state is AuthenticationState.PollingForDeviceCodeToken) {
      """
